 ...
 */
function SidebarCreateBoardModal({ alfterCreateNewBoard }) {
  const { reset } = useForm()
  ...
  return (
    <>
      ...
      <CreateBoardModal alfterCreateNewBoard={alfterCreateNewBoard} isOpen={isOpen} handleCloseModal={handleCloseModal} />
