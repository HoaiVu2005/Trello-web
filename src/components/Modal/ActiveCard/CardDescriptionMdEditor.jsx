 ...
 */
function CardDescriptionMdEditor({ cardDecriptionProp, handleUpdatCardDescription }) {
  ...
  const [cardDescription, setCardDescription] = useState(cardDecriptionProp)

  const updateCardDescription = () => {
    setMarkdownEditMode(false)
    handleUpdatCardDescription(cardDescription)
  }
