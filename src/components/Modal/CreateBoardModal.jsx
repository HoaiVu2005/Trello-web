...
import { FIELD_REQUIRED_MESSAGE } from '~/pages/Ultis/validators'
...
export function CreateBoardModal({ alfterCreateNewBoard, isOpen, handleCloseModal }) {
